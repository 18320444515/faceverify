...
public class RegisterController {
    ...
    @ResponseBody
    public ResultVO user(@RequestParam(value = "Name")String userName,
    ...
    @ResponseBody
    public ResultVO course(@RequestParam(value = "Code") int code,
    ...
    @ResponseBody
    public ResultVO courseClass(@RequestParam(value = "ClassOrder")int classOrder,
    ...
    @ResponseBody
    public ResultVO courseClassStatistics(@RequestParam(value = "TeacherCourseId")int teacherCourseId,
    ...
    @ResponseBody
    public ResultVO courseStatistics(@RequestParam(value = "StudentNum")int studentNum,
    ...
    @ResponseBody
    public ResultVO notice(@RequestParam(value = "Title")String title,
    ...
    @ResponseBody
    public ResultVO studentCourse(@RequestParam(value = "StudentNumber")int studentNumber,
    ...
    @ResponseBody
    public ResultVO studentCourseClass(@RequestParam(value = "StudentNumber")int studentNumber,
                                       @RequestParam(value = "StudentName")String studentName,
    ...
    @ResponseBody
    public ResultVO teacherCourse(@RequestParam(value = "TeacherNumber")int teacherNumber,
